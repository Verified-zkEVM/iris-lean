...
noncomputable section BluebellRules
...
-- set_option synthInstance.maxHeartbeats 1000000000000000
...
theorem RL_Eq_Dist {X : Set (I × Var)} {ix jy : X} :
  ix.1.1 ≠ jy.1.1 →
  ⌊{v : (X → Val) | v ix = v jy}⌋
